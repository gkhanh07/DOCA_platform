...
public class updateSaveProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int OwnerProductID = product.getUserId();
            if (account != null) {
                ...
                if (isSaved.equals("")) {
                    ...
                    notiDao.insertNotification(OwnerProductID, noDes, timeNotification);
                    if (result) {
                        url = "filterProduct"
                                + "?city=" + local
                    ...
                    noDes = Username + " đã bỏ quan tâm sản phẩm " + " - " + first80Chars;
                    notiDao.insertNotification(OwnerProductID, noDes, timeNotification);
                    if (result) {
                        url = "filterProduct"
                                + "?city=" + local
