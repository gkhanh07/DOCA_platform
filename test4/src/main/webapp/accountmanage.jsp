    ...
    <head> <!-- Required meta tags always come first --> 
        ...
        <style>
            .img-account-profile {
                width: 100%;
                height: 100%;
                object-fit: cover; /* Để ảnh avatar điền đầy vùng chứa */
            }         
        </style>
    </head>
    <body>
                                    ...
                                    <form action="DispatchServlet" method="post"  onsubmit="return validateForm()">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card mb-4 mb-xl-0">
                                                ...
                                                <div class="card-body text-center">
                                                    ...
                                                    <div class="avatar-container">
                                                        <img class="img-account-profile rounded-circle border" style="width: 168px; height: 168px;" src="${Owner.avatar}"
                                                             alt="ảnh đại diện">
                                                    </div>
                                                    <h6 class="user-name display-4" style="font: 32px Helvetica, Arial, sans-serif;">${Owner.userName}</h6>
                                                    <hr />
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Form Group (username)-->
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputUsername" >Ảnh đại diện mới</label>
                                                    <input placeholder="Chọn ảnh đại diện mới" type="file" class="form-control" id="inputGroupFile01" name="avatar" >
                                                </div>
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputUsername" >Usename mới<span
                                                ...
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputUsername" >Email mới</label>
                                                    <input class="form-control" id="inputEmail" type="email"
                                                           placeholder="" value="" name="txtEmail">
                                                </div>
                                                <!-- Form Group (Phone)-->
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputPhone">Số điện thoại mới</label>
