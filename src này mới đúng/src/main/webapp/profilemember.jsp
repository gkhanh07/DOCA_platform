                    ...
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                <img src="${OwnerProfile.avatar}" alt="avatar" class="rounded-circle img-fluid"
                                     style="width: 150px;">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="tab-content" class="row">
                            <div id="product" class="tab-pane fade show active">
                                <div class="card-group justify-content-center product">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                               <a href="productDetailServlet?productId=${product.productId}">
                                                ...
                                                <h6 class="card-text">${product.timePosted}</h6>
                                                </a>   
                                            </div>
                                        </div>
                                    </c:forEach>
