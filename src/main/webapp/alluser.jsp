...
<!--    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <c:forEach items="${userListBySearch}" var="user">
                            <tr>
                        <form action="DispatchServlet" method="Post">
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${user.status}">
                                        <a href="DeleteUserSerlvet?user_id=${user.user_ID}&action=ban&txtSearch=${param.txtSearch}" class="btn btn-danger">Ban Account</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="DeleteUserSerlvet?user_id=${user.user_ID}&action=unban&txtSearch=${param.txtSearch}" class="btn btn-success">Unban Account</a>
                                    </c:otherwise>
                                </c:choose></td>
   ...
   <body>
        ...
        <div class="container">
            <form action="DispatchServlet" method="POST" class="mb-3">
                <div class="input-group">
                    <input type="hidden" name="txtSearchDisplay" value="${param.txtSearch}">
                  <input type="text" name="txtSearch" class="form-control" placeholder="Search by Username" value="${param.txtSearch}">
                    <input type="submit" class="btn btn-primary" value="Search User" name="btAction">
                </div>
            </form>
