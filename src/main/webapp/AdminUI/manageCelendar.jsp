        ...
        <div class="container" style="margin-top: 150px;">
            <ul class="nav nav-tabs mb-4">
                <c:if test="${foundShift==true}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link button" data-bs-toggle="tab" onclick="redirectToProductServlet()">Sản phẩm</a>
                    </li>
                    <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active button" data-bs-toggle="tab"  href="#">Lịch làm việc</a>
                </li>
            </ul>
            <div class="container">
                                ...
                                <th class="text-uppercase">Time
                                    <div class="dropdown mt-3 mb-3">
                                        <form id="filterForm" action="MangeDateInWeek" method="post">
                                            ...
                                            <select class="form-select button" aria-label="Default select example" name="selectedWeek"  onchange="filterByCategory()">
