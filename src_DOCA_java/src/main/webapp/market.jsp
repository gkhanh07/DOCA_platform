...
<html>
    ...
    <body>
        ...
        <c:set var="Products" value="${sessionScope.listOfProduct}"/>
        <div id="header"></div>
                ...
                <div class="product-post col-sm-12">
                    ...
                    <div class="btn1 d-flex ">
                        ...
                        <div class="btn-group" style="width: 200px;">
                            <select class="form-select form-select-sm " style="width: 100%;" id="city"
                        ...
                        <div class="dropdown" style="width: 200px;">
                            <select class="form-control" style="width: 200px;">
                                <option value="Chuồng thú cưng">Chuồng thú cưng</option>
                            ...
                            <div style="position: relative; border-bottom: 1px solid rgb(224, 224, 224);">
                                ...
                                <span class="like-icon">
                                    <a href="javascript:void(0);" class="like-button">
                                        <i class="fa fa-heart-o" style="color: red; cursor: pointer; position: absolute; bottom: 30px; right: 40px;"></i>
                                    </a>
                                </span>
                            </div>
                        </c:forEach>
