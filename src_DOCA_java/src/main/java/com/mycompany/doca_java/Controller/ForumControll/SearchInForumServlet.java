 ...
 */
package com.mycompany.doca_java.Controller.ForumControll;
 ...
 * @author Admin
 */
@WebServlet(name = "SearchInForumServlet", urlPatterns = {"/SearchInForumServlet"})
public class SearchInForumServlet extends HttpServlet {
