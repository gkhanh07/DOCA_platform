...
public class RemoveItemFromCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchBooks = request.getParameter("lastSearchItem");
        String urlRewriting = "DispatchServlet"
                + "?btAction=View your cart FullHD"
                + "&lastSearchBook=" + searchBooks;
        try {
            // goes to cart palace
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    //take item
                    String[] items = request.getParameterValues("checkItemDel");
                    if (items != null) {
                        for (String skuItem : items) {
                            cart.removeItemFromCart(skuItem);
                        }
