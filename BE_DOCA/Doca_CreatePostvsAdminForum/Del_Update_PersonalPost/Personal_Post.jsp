...
<html>
    ...
    <body>
                                    ...
                                    <c:forEach items="${listPostOfPersonal}" var="post">
                                        <c:if test="${post.status eq 'pending'}">
                                            ...
                                            <img class="col-sm-6 image-content mt-5 img-fluid"
                                                 src="ImgUploadByUser/${post.postImage}" alt="Hình ảnh">
                                            ...
                                            <!-- Popup Form -->
                                            <div class="modal" id="edit-form${post.postId}" style="margin-top: 5%">
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="UpdatePostByUserServlet" method="post" enctype="multipart/form-data" >
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="form-check form-check-inline">
                                                                        <input name="category" class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                                               value="5" <c:forEach var="categorys" items="${post.categoryId}">
                                                                                   <c:if test="${categorys == 5}">checked</c:if></c:forEach>>
                                                                               ...
                                                                               <div class="form-check form-check-inline">
                                                                                   ...
                                                                                   <c:if test="${categorys == 6}">checked</c:if></c:forEach>>
                                                                               ...
                                                                               <div class="form-check form-check-inline">
                                                                                   ...
                                                                                   <c:if test="${categorys == 7}">checked</c:if></c:forEach>>
                                                                               ...
                                                                               <div class="form-check form-check-inline">
                                                                                   ...
                                                                                   <c:if test="${categorys == 8}">checked</c:if></c:forEach>>
                                                                               ...
                                                                               <div class="form-check form-check-inline">
                                                                                   ...
                                                                                   <c:if test="${categorys == 9}">checked</c:if></c:forEach>>
        ...
        <script>
            <% String message = (String) request.getAttribute("Message_Del");
