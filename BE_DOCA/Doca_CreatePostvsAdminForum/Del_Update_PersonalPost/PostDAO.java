...
//                    }
                    ...
                    boolean resultUpdatedetail = dao.updatePostDetails(postId, updateContent, updateImg);
...
//            }
    ...
    public boolean updatePostDetails(int postId, String updateContent, String updateImg) throws SQLException, ClassNotFoundException, NamingException {
        Connection con = null;
        PreparedStatement stmUpdate = null;
        boolean result = false;
        try {
